...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-secondary bg-secondary">
             <!--Navbar Logo-->
           <img src="assets/img/logo sekolah mts.png" alt="Logo" width="50" height="50" class="me-2">
            <!-- Navbar Brand-->
         <block><a class="navbar-brand ps-3" href="index.php">PERPUSTAKAAN SMK MTS</a>
            <!-- Sidebar Toggle-->
                ...
                <footer class="py-4 mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted"> &copy; SMK MTS</div>
                            <div>
